...
function theme.highlights(colors, config)
  ...
  local function load_editor()
    ...
    local editor = {
      ...
      Directory = { fg = colors.blue, bg = colors.none, style = "bold" },
  ...
  local function load_plugins()
    ...
    local plugins = {
      ...
      NvimTreeGitDirty = { fg = colors.yellow, style = "bold" },
      NvimTreeGitNew = { fg = colors.diff_add, style = "bold" },
      NvimTreeGitStaged = { fg = colors.purple, style = "bold" },
      NvimTreeGitDeleted = { fg = colors.diff_remove, style = "bold" },
      ...
      NavicText = { bg = colors.active, fg = colors.blue },
      NavicSeparator = { bg = colors.active, fg = colors.selection },
      ...
      NeoTreeRootName = { fg = colors.light_green, style = "bold" },
      NeoTreeDirectoryIcon = { fg = colors.yellow },
      NeoTreeDirectoryName = { fg = colors.blue, style = "bold" },
      NeoTreeFilename = { fg = colors.fg },
      NeoTreeFloatBorder = { fg = colors.active, bg = colors.active },
